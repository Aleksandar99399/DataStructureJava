...
public class Tree<E> implements AbstractTree<E> {
    ...
    public void swap(E firstKey, E secondKey) {
        ...
        int i = firstParent.children.indexOf(firstNode);
        int i1 = secondParent.children.indexOf(secondNode);

        firstParent.children.set(i, secondNode);
        secondParent.children.set(i1, firstNode);
